...
<div class="row g-4">
    <div class="col-md-4">
        <div class="card feature-card h-100 p-4">
            ...
            <h3 class="h5">University Authentication</h3>
            <p class="text-muted mb-0">Only verified <?= e('@' . UNIVERSITY_EMAIL_DOMAIN) ?> emails can register, keeping the marketplace safe and trusted.</p>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card feature-card h-100 p-4">
