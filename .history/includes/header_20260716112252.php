        ...
        <div class="collapse navbar-collapse" id="navMain">
            <ul class="navbar-nav me-auto">
                ...
                <?php if (isLoggedIn()): ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= APP_URL ?>/messages/index.php">Messages<?php if ($messageCount > 0): ?> <span class="badge bg-success"><?= $messageCount > 9 ? '9+' : $messageCount ?></span><?php endif; ?></a></li>
                <?php endif; ?>
            </ul>
