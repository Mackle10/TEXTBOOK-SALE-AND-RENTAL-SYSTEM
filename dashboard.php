...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="card stat-card p-4">
            ...
            <p class="mb-2 small text-muted"><?= e($profile['course'] ?? '') ?> — Year <?= (int) ($profile['year_of_study'] ?? 1) ?></p>
                ...
                <tr class="<?= $rowClass ?>">
                    ...
                    <td>
                        <?php if (in_array($r['status'], ['active', 'overdue'], true)): ?>
                            <a href="rentals/return.php?id=<?= (int) $r['rental_id'] ?>" class="btn btn-sm btn-success"
    ...
    <table class="table table-hover bg-white rounded shadow-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= statusBadge($r['status']) ?></td>
                <td>
                    <a href="rentals/return.php?id=<?= (int) $r['rental_id'] ?>" class="btn btn-sm btn-outline-success"
